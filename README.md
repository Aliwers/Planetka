...
```bash
curl -fsSL https://raw.githubusercontent.com/Aliwers/Planetka/v1.2.1/install.sh | /usr/bin/arch -arm64 /bin/bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Aliwers/Planetka/v1.2.1/install.sh | PLANETKA_BUILD_FROM_SOURCE=1 /usr/bin/arch -arm64 /bin/bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Aliwers/Planetka/v1.2.1/uninstall.sh | bash
```
