...
```bash
curl -fsSL https://raw.githubusercontent.com/Aliwers/Planetka/v1.2.4/install.sh | /usr/bin/arch -arm64 /bin/bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Aliwers/Planetka/v1.2.4/install.sh | PLANETKA_BUILD_FROM_SOURCE=1 /usr/bin/arch -arm64 /bin/bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Aliwers/Planetka/v1.2.4/uninstall.sh | bash
```
